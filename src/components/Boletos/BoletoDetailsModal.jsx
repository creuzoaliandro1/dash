  ...
  const handleViewFile = async (anexo) => {
    ...
    if (type === 'pdf') {
      ...
      try {
        ...
        setError('Erro ao carregar Excel: ' + err.message)
      }
    }
  }
          ...
          {viewMode === 'preview' ? (
            <div className="space-y-4">
              ...
              {fileType === 'pdf' && fileUrl && (
                <iframe
                  src={fileUrl + '#navpanes=0&zoom=75'}
              ...
              {fileType === 'xml' && fileContent && (
                <pre className="bg-[#111111] border border-[#2a2a2a] rounded p-4 text-[#51cf66] text-sm overflow-auto max-h-[950px] font-mono">
                  {fileContent}
                </pre>
              )}
              ...
              {fileType === 'excel' && excelData && (
                <div className="space-y-4">
                  ...
                  {/* Excel Table */}
                  <div className="overflow-auto border border-[#2a2a2a] rounded bg-[#111111] max-h-[950px]">
                    <table className="text-sm table-fixed">
                      <thead>
                        <tr className="border-b border-[#2a2a2a] bg-[#1a1a1a]">
                          {excelData[currentSheet]?.[0]?.map((cell, idx) => (
                            <th
                              key={idx}
                              className="px-1 py-2 text-left font-medium text-white border-r border-[#2a2a2a] last:border-r-0 max-w-[20px] overflow-visible"
                            >
                              <div className="whitespace-nowrap" title={cell !== null && cell !== undefined ? String(cell) : ''}>
                      ...
                      <tbody>
                        {excelData[currentSheet]?.slice(1).map((row, rowIdx) => (
                          <tr key={rowIdx} className="border-b border-[#2a2a2a] hover:bg-[#1a1a1a] transition">
                            {row?.map((cell, cellIdx) => (
                              <td
                                key={cellIdx}
                                className="px-1 py-2 text-[#a3a3a3] border-r border-[#2a2a2a] last:border-r-0 max-w-[20px] overflow-visible"
                              >
                                <div className="whitespace-nowrap" title={cell !== null && cell !== undefined ? String(cell) : ''}>
                                  {cell !== null && cell !== undefined ? String(cell) : '—'}
                                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4" style={{ gridTemplateColumns: '1fr 0.5fr 0.5fr 0.5fr' }}>
                <div>
