...
export default function Sidebar({ currentPage, setCurrentPage, allContas = [], onContaSwitch }) {
  ...
  const navItems = [
    ...
    ...(isMaster ? [{
      ...
      // Contábil — visível apenas para usuários Master
      id: 'contabil',
      label: 'Contábil',
      icon: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      // WhatsApp — visível apenas para usuários Master: conecta (via QR) o número
      // que o sistema usa para enviar boletos. O envio em si é liberado a todos.
      id: 'whatsapp',
      label: 'WhatsApp',
      icon: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
