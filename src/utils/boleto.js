...
// (BMP Money Plus, v1 - 01/2026). O BMP EXIGE este leiaute para
// remessa de troca de cedente (NAO o layout padrao de Registro).
//
...
const buildTrocaTipo4 = (boleto, lineSeq) => {
    ...
    line += padLeft(sacadoCic, 14)                 // 004-017    - no inscricao (14)
    ...
    line += ' '.repeat(6)                          // 098-103    - no endereco (brancos)
...
export const generateCNAB400TrocaCedenteFile = async (boletos, contaRecebedor, contaOriginal, onProgress) => {
    ...
    console.log('[CNAB400-Troca] Remessa (layout troca de cedente) gerada:', lines.length, 'linhas')
