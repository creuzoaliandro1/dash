...
async function executeSQL() {
  try {
    console.log('🔐 Configurando RLS Policies no Supabase...\n');
    ...
    if (response.ok) {
      ...
      console.log('ℹ️  Método automático indisponível.\n');
      return false;
    }
  } catch (error) {
...
if (!success) {
  ...
  console.log('5. Cole o conteúdo do arquivo: setup-storage-rls.sql');
  console.log('6. Clique em "Execute"');
  console.log('7. Após executar, teste a importação de boletos novamente\n');
  console.log('📄 Arquivo: C:\\Projetos\\Capt\\setup-storage-rls.sql');
}
